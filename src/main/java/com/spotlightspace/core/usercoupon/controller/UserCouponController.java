...
public class UserCouponController {
     ...
     * @return          발급된 쿠폰 정보가 포함된 ResponseEntity
     */
    ...
    public ResponseEntity<UserCouponIssueResponseDto> issueCouponBasic(
        ...
        UserCouponIssueResponseDto responseDto = userCouponService.issueCouponBasic(authUser, couponId);
        return ResponseEntity.ok(responseDto);
    }

    /**
     * 비관적 락 + Redis 대기열 쿠폰 발급
     * @param authUser  인증된 사용자 정보
     * @param couponId  발급할 쿠폰의 ID
     * @return          발급된 쿠폰 정보가 포함된 ResponseEntity
     */
    ...
    public ResponseEntity<UserCouponIssueResponseDto> issueCouponWithPessimisticLockAndQueue(
        ...
        UserCouponIssueResponseDto responseDto = userCouponService.issueCouponWithPessimisticLockAndQueue(authUser, couponId);
        return ResponseEntity.ok(responseDto);
    }
